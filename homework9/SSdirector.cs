...
public class Clickable : MonoBehaviour
{
    ...
    void OnMouseDown()
    {
        ...
        if(gameObject.name == "boat")
        {
            ...
            action.moveBoat();
            int rightPriest = controller.rBank.getBankState()[0];
            int rightDevil = controller.rBank.getBankState()[1];
            int leftPriest = controller.lBank.getBankState()[0];
            int leftDevil = controller.lBank.getBankState()[1];
            bool location = (controller.boat.boatStatus == 1) ? true : false;
            ...
            FirstController.state = new IState(leftPriest, leftDevil, rightPriest, rightDevil, location, null);
        } else
        {
